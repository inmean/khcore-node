...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `khcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ khcore-node add wallet-service');
      console.log('    $ khcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ khcore-node remove wallet-service');
      console.log('    $ khcore-node remove insight-api');
      console.log();
    });
