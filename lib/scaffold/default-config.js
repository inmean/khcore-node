 ...
 * configuration file in the "~/.khcoin" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.khcoin');
  var defaultConfigFile = path.resolve(defaultPath, './khcore-node.json');
      ...
      servicesConfig: {
        bitcoind: {
          spawn: {
            ...
            exec: path.resolve(__dirname, '../../bin/khcoind')
          }
        }
      }
    };
